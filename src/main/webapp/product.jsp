...
<body>
	...
	<div class="text-center">
		<ul class="pagination justify-content-center">
			<c:if test="${tag > 1}">
				<li class="page-item">
					<a class="page-link" href="product?page=${tag-1}&sizepage=${size}" aria-label="Previous">
			...
			<c:forEach begin="1" end="${end}" var="i">
				<li class="page-item ${tag == i ? "active" : "" }"><a class="page-link" href="product?page=${i}&sizepage=${size}">${i}</a></li>
			</c:forEach>
			<c:if test="${tag < end}">
				<li class="page-item">
					<a class="page-link" href="product?page=${tag+1}&sizepage=${size}" aria-label="Next">
